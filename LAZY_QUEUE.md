...
| # | item | state | sev |
|---|------|-------|------|
| 1 | [adhoc-incident-hook-deny-4b767b](docs/bugs/adhoc-incident-hook-deny-4b767b/SPEC.md) | Validate | — |
| | status: Validate · phase 0/1 · next: run mcp-test · The `_LAZY_BATCH_RE` recursion trip in `lazy-cycle-containment.sh` matches a `lazy-batch` token ANYWHERE in a subagent's Bash command — including benign file-path references (`cat`/`grep`/`ls`/`git add` on the `lazy-batch*` skill files). | | |
...
| 3 | [skip-mcp-test-frontmatter-unquoted-colon](docs/bugs/skip-mcp-test-frontmatter-unquoted-colon/SPEC.md) | Validate | P0 |
...
| 4 | [build-queue-enforce-cd-prefix-bypass](docs/bugs/build-queue-enforce-cd-prefix-bypass/SPEC.md) | Spec | — |
...
| 5 | [build-queue-no-artifact-or-process-hygiene-on-crash](docs/bugs/build-queue-no-artifact-or-process-hygiene-on-crash/SPEC.md) | Implement | — |
...
| 6 | [build-queue-copy-lock-stale-dll-false-success](docs/bugs/build-queue-copy-lock-stale-dll-false-success/SPEC.md) | Implement | — |
...
| 7 | [test-filtered-stale-check-hardcodes-bin-debug](docs/bugs/test-filtered-stale-check-hardcodes-bin-debug/SPEC.md) | Validate | — |
...
| 8 | [build-queue-recycle-kills-concurrent-worktree-build](docs/bugs/build-queue-recycle-kills-concurrent-worktree-build/SPEC.md) | Implement | — |
...
| 9 | [write-plan-plans-bypass-build-queue-skills](docs/bugs/write-plan-plans-bypass-build-queue-skills/SPEC.md) | Spec | — |
...
| 10 | [build-queue-orphaned-result-on-wrapper-kill](docs/bugs/build-queue-orphaned-result-on-wrapper-kill/SPEC.md) | Validate | — |
...
| 11 | [crlf-hook-blanket-enforce-mixed-eol](docs/bugs/crlf-hook-blanket-enforce-mixed-eol/SPEC.md) | Spec | — |
...
| 12 | [worktree-claude-doc-drift](docs/bugs/worktree-claude-doc-drift/SPEC.md) | Validate | — |
...
| 13 | [build-queue-outcome-opacity-and-inspect-deny](docs/bugs/build-queue-outcome-opacity-and-inspect-deny/SPEC.md) | Validate | — |
...
| 14 | [adhoc-align-cycle-commit-count-with-budget-population](docs/bugs/adhoc-align-cycle-commit-count-with-budget-population/SPEC.md) | Spec | — |
| | status: Spec · next: spec | | |
| 15 | [adhoc-derive-multi-commit-budget-from-dispatch-sites](docs/bugs/adhoc-derive-multi-commit-budget-from-dispatch-sites/SPEC.md) | Spec | — |
| | status: Spec · next: spec | | |
