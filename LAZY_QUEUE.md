...
| # | item | state | tier |
|---|------|-------|------|
| 1 | [mechanize-prose-only-orchestrator-contracts](docs/features/mechanize-prose-only-orchestrator-contracts/SPEC.md) | Pending | T1 |
...
| 2 | [coupled-pair-generation](docs/features/coupled-pair-generation/SPEC.md) | Pending | T1 |
...
| 3 | [lazy-core-package-decomposition](docs/features/lazy-core-package-decomposition/SPEC.md) | Plan | T1 |
...
| 4 | [anti-overfit-design-gate](docs/features/anti-overfit-design-gate/SPEC.md) | Pending | T2 |
...
| 5 | [shared-hook-lib](docs/features/shared-hook-lib/SPEC.md) | Research | T2 |
...
| 6 | [skill-config-schema-and-reference-lint](docs/features/skill-config-schema-and-reference-lint/SPEC.md) | Pending | T2 |
...
| 7 | [cycle-prompt-environment-dialect](docs/features/cycle-prompt-environment-dialect/SPEC.md) | Pending | T2 |
...
| 8 | [plan-structure-authoring-gate](docs/features/plan-structure-authoring-gate/SPEC.md) | Pending | T2 |
...
| 9 | [efficacy-signal-integrity](docs/features/efficacy-signal-integrity/SPEC.md) | Pending | T2 |
...
| 10 | [lazy-batch-skill-deflation](docs/features/lazy-batch-skill-deflation/SPEC.md) | Pending | T2 |
...
| 11 | [bug-queue-aging-backpressure](docs/features/bug-queue-aging-backpressure/SPEC.md) | Pending | T2 |
| | status: Pending · phase 3/3 · next: queue · The harness bug backlog only accumulates. | | |
| 12 | [claude-config-ci](docs/features/claude-config-ci/SPEC.md) | ⬡ Needs-input | T3 |
...
| 13 | [native-android-pipeline-steering](docs/features/native-android-pipeline-steering/SPEC.md) | Research | T3 |
