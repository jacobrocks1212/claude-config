...
| # | item | state | tier |
|---|------|-------|------|
| 1 | [concurrent-worktree-agent-coordination](docs/features/concurrent-worktree-agent-coordination/SPEC.md) | Spec | T0 |
| | status: Spec · next: spec | | |
| 2 | [shared-hook-lib](docs/features/shared-hook-lib/SPEC.md) | Implement | T2 |
