...
description: USE WHEN working with Vue, Vue.js, Vue 2, Vue 3, or .vue files. USE WHEN building Vue components, using Composition API, refs, reactive, computed, watch, or Vue directives. USE WHEN working in Cognito.Web.Client or any Vue frontend code. Triggers on "Vue", "vue", ".vue", "ref(", "reactive(", "computed(", "watch(", "defineProps", "defineEmits", "v-if", "v-for", "v-model", "Composition API", "Options API", "Pinia".
category: frontend
