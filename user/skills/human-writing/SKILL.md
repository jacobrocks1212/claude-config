...
## Jacob's Personal Writing Style

**IMPORTANT**: When writing for Jacob, ALWAYS reference `jacob-style.md` in this skill folder. This file contains Jacob's actual writing patterns extracted from real conversations and should be the primary guide for voice and tone.

Key characteristics of Jacob's style:
- Opens with "Hey [name]," or "Morning [name]," — never "I hope this finds you well"
- Gets straight to the point after greeting
- Uses "whenever you get a chance" for non-urgent requests
- Acknowledges with "Sounds good", "Gotcha", "Yeah"
- Uses contractions naturally (I'll, wouldn't, that's, we're)
- Never says "excited", "thrilled", or corporate buzzwords
- Ends with "Thanks [name]" or "Lmk if you have issues"

See `jacob-style.md` for complete examples and transformations.
