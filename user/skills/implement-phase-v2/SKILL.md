---
description: Draft a TDD implementation plan for a PHASES.md phase using parallel Sonnet subagents (v2 — reference-based components)
argument-hint: <path/to/PHASES.md> [phase number]
name: implement-phase-v2
plan-mode: required
---
