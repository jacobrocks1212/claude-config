---
name: fabric
description: Native Fabric pattern execution (extract_wisdom, summarize, analyze_claims, threat modeling, …) in Claude's context. Use the fabric CLI only for YouTube transcripts (-y) or pattern updates (-U).
---
