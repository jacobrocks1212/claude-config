...
def run_smoke_tests() -> int:
    ...
    cases: list[tuple] = [
        ...
        # 12. Operator-deferred skip: deferred bug is skipped; actionable bug is selected
        (
        ...
        # 13. All operator-deferred: only remaining bug has DEFERRED.md → all-remaining-deferred
        (
