...
# lazy-core-package-decomposition Phase 5 WU-1: the run-marker / ownership /
# refusals / cycle-bracket plane moved to markers.py. Names below are still
# referenced by monolith-resident code (apply_pseudo, until WU-2) — imported
# back by value.
