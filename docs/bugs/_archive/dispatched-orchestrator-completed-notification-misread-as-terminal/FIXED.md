---
kind: fixed
feature_id: dispatched-orchestrator-completed-notification-misread-as-terminal
date: 2026-07-18
...
- 4197e5d8 — harden(skill-prose): add dispatched-agent-liveness receiver contract for completed-notification misread
