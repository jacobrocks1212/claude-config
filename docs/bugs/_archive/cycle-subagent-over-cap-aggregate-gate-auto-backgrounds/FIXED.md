---
kind: fixed
feature_id: cycle-subagent-over-cap-aggregate-gate-auto-backgrounds
date: 2026-07-18
...
- 8ce9aa0e — harden(skill-prose): decompose over-cap aggregate gate into under-cap foreground sub-components (never background from a cycle subagent)
