...
**Related:** `docs/bugs/build-queue-copy-lock-stale-dll-false-success/` (parent — this is a defect in that spec's shipped Phase 3 "test honesty"); `docs/bugs/build-queue-no-artifact-or-process-hygiene-on-crash/`
