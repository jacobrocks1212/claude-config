---
kind: fixed
feature_id: adhoc-cli-surface-registry-stale-set-independent
date: 2026-07-18
...
- b43cf70e — chore(no-sanctioned-cli-for-queue-state-mutations): verify landed CLI fix, regenerate cli-surface.json
