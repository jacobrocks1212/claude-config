---
kind: fixed
feature_id: planning-audit-blind-to-inbound-module-path-loads
date: 2026-07-18
...
- ee90acca — harden(skill-prose): add module-move inbound-seam audit to planning-time capability audits
