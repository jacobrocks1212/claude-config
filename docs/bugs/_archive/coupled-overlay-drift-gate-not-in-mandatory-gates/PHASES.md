...
- [x] Tests: the recurrence-guard test above (RED before the manifest edit, GREEN after) plus the full battery re-run confirming 8 gates all pass on the clean tree.
