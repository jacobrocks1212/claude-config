---
kind: fixed
feature_id: live-settings-probe-false-positive-in-consumer-repo
date: 2026-07-18
...
- 406fa426 — harden(hook,script): redirect heavy qg gates to orchestrator ownership + fix consumer-repo live-settings false-positive
