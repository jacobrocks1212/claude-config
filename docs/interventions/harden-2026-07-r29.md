---
kind: intervention
intervention_id: harden-2026-07-r29
pipeline: hardening
provenance: manual
...
# Intervention: harden-2026-07-r29

Hypothesis: shipping `harden-2026-07-r29` (hardening pipeline) moves `undeclared` in direction `undeclared` within 20 post-ship runs.
