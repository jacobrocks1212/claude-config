---
kind: intervention
intervention_id: efficacy-signal-integrity
pipeline: feature
provenance: gated
...
# Intervention: efficacy-signal-integrity

Hypothesis: shipping `efficacy-signal-integrity` (feature pipeline) moves `undeclared` in direction `undeclared` within 20 post-ship runs.
