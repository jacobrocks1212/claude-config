---
kind: intervention
intervention_id: adhoc-lane-plan-single-lane-seam-classification
pipeline: bug
provenance: gated
...
# Intervention: adhoc-lane-plan-single-lane-seam-classification

Hypothesis: shipping `adhoc-lane-plan-single-lane-seam-classification` (bug pipeline) moves `undeclared` in direction `undeclared` within 20 post-ship runs.
