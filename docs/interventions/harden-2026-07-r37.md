---
kind: intervention
intervention_id: harden-2026-07-r37
pipeline: hardening
provenance: manual
shipped_date: '2026-07-13'
shipped_commit: ee90accaeb5b9359a561e0d24b1c3133dfb1a1fc
commit_set: ee90accaeb5b9359a561e0d24b1c3133dfb1a1fc
target_signal: undeclared
expected_direction: decrease
signal_independence: immeasurable-by-construction — the fixed friction class is the
  ABSENCE of signal (a gate machinery crash synthesized a silent PASS; no ledger event
  type counts a non-event's recurrence). Post-fix the class self-announces as [ERROR]
  (infrastructure) findings / BLOCKED.md blocker_kind plan-structural-invalid / probe
  diagnostics, none of which are discrete telemetry-ledger events. Explicitly typed
  undeclared per the D2 sibling guidance; INCONCLUSIVE-by-construction, surfaced for
  triage.
baseline:
...
canary:
  ...
  window_runs: 10
  surfaces:
  - user/skills/_components/phases-runtime-validation.md
  commit_set:
  - ee90accaeb5b9359a561e0d24b1c3133dfb1a1fc
  pair_scope: []
  degraded_revert_note: null
  status: closed-clean
---

# Intervention: harden-2026-07-r37

Hypothesis: shipping `harden-2026-07-r37` (hardening pipeline) moves `undeclared` in direction `decrease` within 20 post-ship runs.
