---
kind: intervention
intervention_id: execute-plan-skill-diet
pipeline: feature
provenance: gated
...
# Intervention: execute-plan-skill-diet

Hypothesis: shipping `execute-plan-skill-diet` (feature pipeline) moves `undeclared` in direction `undeclared` within 20 post-ship runs.
