---
kind: intervention
intervention_id: plan-structure-authoring-gate
pipeline: feature
provenance: gated
shipped_date: '2026-07-13'
shipped_commit: dd90661903b7e2d9dd01891b7e74b0a95348b2ee
commit_set: dd90661903b7e2d9dd01891b7e74b0a95348b2ee
...
# Intervention: plan-structure-authoring-gate

Hypothesis: shipping `plan-structure-authoring-gate` (feature pipeline) moves `undeclared` in direction `undeclared` within 20 post-ship runs.
