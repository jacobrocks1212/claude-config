---
kind: intervention
intervention_id: adhoc-containment-denies-mandated-explore-fanout
pipeline: bug
provenance: gated
...
# Intervention: adhoc-containment-denies-mandated-explore-fanout

Hypothesis: shipping `adhoc-containment-denies-mandated-explore-fanout` (bug pipeline) moves `undeclared` in direction `undeclared` within 20 post-ship runs.
