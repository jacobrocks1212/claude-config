...
| KPI | current | baseline | band (warn/breach) | status |
|-----|---------|----------|--------------------|--------|
| Runaway containment trip rate | 3382/30d | pending | — | PENDING-BASELINE |
...
| KPI | current | baseline | band (warn/breach) | status |
|-----|---------|----------|--------------------|--------|
| Cycles per completion | 8.89 (30d) | pending | — | PENDING-BASELINE |
...
| Count of docs/bugs/ items at Status: Concluded (investigated, never fixed) `[claude-config]` | 43 (1d) | 23 (measured 2026-07-11) | — | PENDING-BASELINE |
