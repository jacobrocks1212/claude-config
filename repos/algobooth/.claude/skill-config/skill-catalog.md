...
- **environment-platform** → `tauri-patterns`, `rust-best-practices`, `rust-errors`, `tauri-build`, `cargo-release`, `qg-rust`, `qg-sidecar` (workstation-only queue-routed builds + heavy quality gates)
